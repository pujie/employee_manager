...
<div class="demo">
	...
	echo form_open('clients/edit_handler2');
	$client=new Client;
	$client->where('id',$this->uri->segment(4))->get();
	?>
	<?php echo form_hidden('id',$this->uri->segment(4));?>
	<?php echo form_hidden('page',$this->uri->segment(3));?>
	<div id="tabs">
	<ul>
	...
	<a id='backbutton' href='<?php echo base_url();?>/index.php/clients/list_clients/<?php echo $this->uri->segment(3);?>'>Kembali</a>
	<?php echo form_close();?>
	</div>
