		...
		<?php
		$header=array('id','name','address');
		$body=array(array('1','Jack','Jakarta'),array('2','Jock','Jogjakarta'),array('3','Sur','Surabaya'));
		echo $this->lib_table->set_table('contoh',$header,$body);
		?>
